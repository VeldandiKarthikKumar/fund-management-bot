...
class Settings(BaseSettings):
    ...
    watchlist: list[str] = [
        ...
        "SUNPHARMA", "BAJFINANCE", "WIPRO", "ULTRACEMCO", "NTPC",
        "POWERGRID", "ONGC", "JSWSTEEL", "TATAMOTORS", "TECHM",
        "HCLTECH", "BAJAJFINSV", "GRASIM", "ADANIENT", "ADANIPORTS",
        "COALINDIA", "BRITANNIA", "DIVISLAB", "DRREDDY", "NESTLEIND",
        "CIPLA", "EICHERMOT", "TATACONSUM", "BPCL", "SHRIRAMFIN",
        "APOLLOHOSP", "HEROMOTOCO", "TRENT", "INDUSINDBK", "HINDALCO",
        "BAJAJ-AUTO", "TATASTEEL", "M&M", "SBILIFE", "HDFCLIFE",
        # Nifty Midcap 50 (selective)
        "MUTHOOTFIN", "PIIND", "PERSISTENT", "COFORGE", "LTIM",
        "ABCAPITAL", "FEDERALBNK", "IDFCFIRSTB", "BANDHANBNK", "PNB",
        "CANBK", "UNIONBANK", "MARICO", "GODREJCP", "DABUR",
        "BERGEPAINT", "VOLTAS", "HAVELLS", "POLYCAB", "DIXON",
    ]
